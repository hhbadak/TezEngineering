...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('Assets/img/Services/Adsız%20tasarım%20(5).png');" alt="Tez Mühendislik Planlama ve Proje Takibi">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="tab-1">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                            <img src="Assets/img/Planning/planlama.webp" alt="Tez Harita Mühendislik Planlama" class="img-fluid w-75">
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="tab-2">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="Assets/img/Planning/proje%20takibi.webp" alt="Tez Harita Mühendislik proje takibi" class="img-fluid">
                        </div>
                    </div>
                </div>
                <!-- End tab content item -->
                ...
                <div class="tab-pane" id="tab-3">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="Assets/img/Planning/planların%20onaylanması.webp" alt="Tez Harita Mühendislik planların onaylanması" class="img-fluid">
                        </div>
                    </div>
                </div>
                <!-- End tab content item -->
                ...
                <div class="tab-pane" id="tab-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="Assets/img/Planning/proje%20teslm.webp" alt="Tez Harita Mühendislik proje teslimi" class="img-fluid">
                        </div>
                    </div>
                </div>
                <!-- End tab content item -->
