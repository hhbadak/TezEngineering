                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img" src="Assets/img/Project/Services/kadastro%20projeleri.webp" alt="kadastro projeleri">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img" src="Assets/img/Project/Services/üst%20yapı.webp" alt="üst yapı hizmetleri">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img" src="Assets/img/Project/Services/altyapı%20ölçü.webp" alt="altyapı hizmetleri">
                            <div class="service-text p-5">
                                <div class="bg-dark-subtle opacity-75 rounded-top-pill">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img" src="Assets/img/Project/Services/halihazır%20harita%20üretimi.webp" alt="halihazır harita üretimi">
                            <div class="service-text p-5">
                                <div class="bg-dark-subtle opacity-75 rounded-top-pill">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img" src="Assets/img/Project/Services/iha%20ile%20haritalama%20.webp" alt="iha ile haritalama">
                            <div class="service-text p-5">
                                <div class="bg-dark-subtle opacity-75 rounded-top-pill">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img" src="Assets/img/Project/Services/fotogrametrik.webp" alt="fotogrametrik haritalar">
                            <div class="service-text p-5">
                                <div class="bg-dark-subtle opacity-75 rounded-top-pill">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img" src="Assets/img/Project/Services/3B%20mimari.webp" alt="3b mimari">
                            <div class="service-text p-5">
                                <div class="bg-dark-subtle opacity-75 rounded-top-pill">
                                    <%--<img class="mb-4" src="Assets/img/icons/icon-6.png" alt="Icon">--%>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img" src="Assets/img/Project/Services/şehir%20bölge%20plan%20danışmanlığı.webp" alt="şehir planlama">
                            <div class="service-text p-5">
                                <div class="bg-dark-subtle opacity-75 rounded-top-pill">
                                    <%--<img class="mb-4" src="Assets/img/icons/icon-6.png" alt="Icon">--%>
